...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "GEO vs SEO: The 2026 Guide â€” itappens.ai",
      ...
      <div style={{ minHeight: "100vh", background: "#ffffff", fontFamily: "Outfit, sans-serif" }}>
        ...
        <header style={{ maxWidth: 760, margin: "0 auto", padding: "64px 24px 40px" }}>
          ...
          <p style={{ fontSize: "1.2rem", color: "#6b7280", lineHeight: 1.7, margin: 0 }}>
            ...
            These are two completely different games â€” and in 2026, the new game is the only one that matters for
        ...
        <article style={{ maxWidth: 760, margin: "0 auto", padding: "0 24px 80px" }}>
          ...
          <section style={{ marginBottom: 48 }}>
            ...
            <p style={{ fontSize: "1.05rem", lineHeight: 1.8, color: "#374151", marginBottom: 16 }}>
              ...
              from traditional Google results. Users are getting answers directly from AI interfaces â€”
              ChatGPT, Perplexity, Gemini, Claude, and Grok â€” without clicking any link.
            </p>
            <p style={{ fontSize: "1.05rem", lineHeight: 1.8, color: "#374151" }}>
              ...
              <strong> your goal is no longer a ranking â€” it is a citation.</strong>
            </p>
          </section>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.95rem" }}>
                ...
                <tbody>
                  {[
                    ...
                    ["Timeline", "6â€“12 months", "8â€“12 weeks (first citations)"],
                    ...
                    ["Competition", "Saturated (every brand does it)", "Open window â€” <200 Indian brands GEO-ready"],
                  ].map(([dim, seo, geo], i) => (
          ...
          <section style={{ marginBottom: 48 }}>
            ...
            <p style={{ fontSize: "1.05rem", lineHeight: 1.8, color: "#374151", marginBottom: 24 }}>
              GEO is not a single tactic â€” it is a four-layer system that compounds over time.
              Miss one layer and your citations will plateau.
            </p>
            {[
              { num: "01", title: "Semantic Identity Seeding", body: "AI models recognize brands as named entities in their latent space. Your brand needs a structured knowledge definition â€” a machine-readable identity document â€” before any AI model will confidently name you in a response." },
              { num: "02", title: "Information Gain Content", body: "AI reasoning engines cite sources that provide unique, data-dense information. Generic blog posts do not get lifted. GEO content is engineered in 40â€“60 word 'golden snippets' â€” verbatim-liftable by AI systems." },
          ...
          <section style={{ marginBottom: 48 }}>
            ...
            <p style={{ fontSize: "1.05rem", lineHeight: 1.8, color: "#374151", marginBottom: 16 }}>
              ...
              in your category â€” before competitors do â€” is open for a narrow period in 2026.
            </p>
            <p style={{ fontSize: "1.05rem", lineHeight: 1.8, color: "#374151" }}>
          ...
          <div style={{ background: "#0f0d0a", borderRadius: 16, padding: "40px 32px", textAlign: "center" }}>
            ...
            <p style={{ color: "#9ca3af", margin: "0 0 24px", lineHeight: 1.6 }}>
              Free AI Audit â€” we run 50+ queries across ChatGPT, Perplexity, Gemini and Claude.
